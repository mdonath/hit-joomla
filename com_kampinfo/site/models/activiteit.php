...
class KampInfoModelActiviteit extends KampInfoModelParent {
	...
	function getHitKampById($hitcampId) {
		...
		$query->select("p.jaar as jaar, p.id as hitproject_id, p.inschrijvingStartdatum as startInschrijving, p.inschrijvingEinddatum as eindInschrijving, IF(c.isouderkind,p.ouderkind,'') AS ouderkind ");
