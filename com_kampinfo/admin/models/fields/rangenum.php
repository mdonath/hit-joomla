 ...
 * @since  3.2
 */
class JFormFieldRangenum extends JFormFieldNumber
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		return '<input type="range" name="' . $this->name . '" id="' . $this->id . '"' . ' value="'
			...
			. ' oninput="this.form.' . $this->id . '_display.value=this.form.' . $this->id . '.value;" />'
			. '&nbsp;<output id="' . $this->id . '_display" for="'.$this->name.'">' . $value . '</output>';
	}
}
