	...
	function display($cachable = false, $urlparams = false) {
		...
		if ($layout == 'edit') {
			...
			if ($view == 'hitprojects' && !$this->checkEditId('com_kampinfo.edit.hitproject', $id)) {
				...
				$this->setRedirect(Route::_('index.php?option=com_kampinfo&view=hitprojects', false));
				return false;
				...
				$this->setError(Text::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
				$this->setMessage($this->getError(), 'error');
				$this->setRedirect(Route::_('index.php?option=com_kampinfo&view=hitsites', false));
				return false;
				...
				$this->setError(Text::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
				$this->setMessage($this->getError(), 'error');
				$this->setRedirect(Route::_('index.php?option=com_kampinfo&view=hitcamps', false));
				return false;
			}
		}
