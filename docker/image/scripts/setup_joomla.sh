...
php joomla.php group:add --name="HIT Nijmegen Kamp" --parent="KampInfo"
php joomla.php group:add --name="HIT Nijmegen" --parent="HIT Nijmegen Kamp"
...
php joomla.php group:add --name="HIT Zandvoort Kamp" --parent="KampInfo"
php joomla.php group:add --name="HIT Zandvoort" --parent="HIT Zandvoort Kamp"
...
php joomla.php user:add --username=hitnijmegen --name="C-team HIT Nijmegen" --password="hithithithit" --usergroup="HIT Nijmegen" --email="noreply+hitnijmegen@hit.scouting.nl"
...
php joomla.php user:add --username=hitzandvoort --name="C-team HIT Zandvoort" --password="hithithithit" --usergroup="HIT Zandvoort" --email="noreply+hitzandvoort@hit.scouting.nl"
